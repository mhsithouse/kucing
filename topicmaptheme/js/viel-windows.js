...
function Lw(lid,urls,ani){ //leap window
    ...
    this.urls = urls;
    this.ani = ani;
    $('lw_content').insert('<div class="leap_window" id="'+lid+'" style="display:none;"><div class="leap_window_border"><div class="leap_window_header"><div style="cursor:pointer;" onclick="lwclose(\''+lid+'\');" id="close_button_'+lid+'" class="irc_cb" >x</div><div style="cursor:pointer;" onclick="lwrefresh(\''+lid+'\');" id="ref_button_'+lid+'" class="irc_cb" >r</div></div><div id="'+lid+'_content" class="leap_content"><div id="'+lid+'_contentdlm" class="leap_contentdlm"></div></div></div></div>','top');
    $(lid+'_contentdlm').load(urls, {spinner:    $('loadingtop'),
    onSuccess: function(){
         
        var z = Draggable.Options.zIndex++;
        maxzIndex = z;
...
function PopLw(lid,urls,x,y){ //leap pop window
   ...
   if(urls!='local')$(lid+'_contentdlm').load(urls, {spinner:    $('loadingtop'),
    onSuccess: function(){
