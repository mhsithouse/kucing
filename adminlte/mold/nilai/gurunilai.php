<?
    //pr($arr);
$t=time();
//echo "Kelas: ". $arr['kls_id'] . "<br>";
//echo "Mata pelajaran: ". $mpIDSelected . "<br>";
?>
...
<!--    <div class="col-md-3 col-xs-12">
	...
	Selection::mySubjectSelector($mp, $urlOnChange);  
        ...
        ?>
          ...
          <div class="col-md-2">
          <?          
          //select on kelas dan MP
          $urlOnChange = _SPPATH.$webClass."/".$method."?klsIDSelected=".$kls->kelas_id . "&mpIDSelected=" .$mp->mp_id ;      
          Selection::SelectKelasByOPbjectGuru($arr['guru'], $kls->kelas_id,  $arr[ta], $urlOnChange);
         
          ?>
      </div>
    <div class ="col-md-2">
        <?        
         Selection::SelectMPByObjectGuru($arr['guru'],  $arr[ta], $kls->kelas_id, $mp->mp_id, $urlOnChange);  
          $urlOnChange = _SPPATH.$webClass."/".$method."?klsIDSelected=".$kls->kelas_id . "&mpIDSelected=" .$mp->mp_id ;      
                ...
                <?
                    ...
                    { ?>
                        ...
                        <span  id="dateNote_<?=$note->name_nilai_id;?>" style="padding: 6px;" contenteditable="true" onblur="changeDateNote('<?=$note->name_nilai_id;?>');">
                         <?=date("d-m-Y", strtotime($note->name_nilai_date));?>   
