<?
$t = time();
//pr($arr['guru']->_mengajar);
foreach($arr['guru']->_mengajar as $help=>$value){
    echo "kelas";
    if($help == $arr[ta]){
        echo "in";
...
<div class="row" style="margin-bottom: 10px;">
    ...
    <div class ="col-md-2">
        <button class="btn btn-default" id = "create_<?=$t;?>">Create Quiz</button>      
    </div>
    
    <div class ="col-md-2">
        <button class="btn btn-default">Add File</button>      
    </div>
  </div>  

<script>
    $('#create_<?=$t;?>').click(function(){
        alert("hi");
    });
</script>
<div class="row">
